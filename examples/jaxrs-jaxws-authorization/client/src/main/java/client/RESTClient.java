...
/**
 *  Example showing JAX-RS and JAX-WS proxies making calls to JAX-RS and JAX-WS services 
 *  by relying on the same shared code making remote invocations. 
 *
 */
public final class RESTClient {
    ...
    public void sayHelloRest() throws Exception {
        ...
        // User
        service = JAXRSClientFactory.create(address, HelloWorld.class,
        		"user", "user", null);
    ...
    private HelloWorld createSoapService(String name, String password) throws Exception {
        ...
        ((BindingProvider)hw).getRequestContext().put(
    ...
    private void useHelloServiceRest(HelloWorld service, String user, boolean admin) {
    	...
    	System.out.println("Using HelloServiceRest with " 
    			+ (admin ? "admin" : "user") + " priviliges");
    ...
    private void useHelloServiceSoap(HelloWorld service, String user, boolean admin) {
    	...
    	System.out.println("Using HelloServiceSoap with " 
    			+ (admin ? "admin" : "user") + " priviliges");
